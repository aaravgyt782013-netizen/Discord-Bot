...
module.exports = async (client, interaction, args) => {
  ...
  try {
    ...
    const categories = (ticketData.Categories?.length ? ticketData.Categories : [{
      Name: "Support", Category: ticketData.Category, Role: ticketData.Role, Logs: ticketData.Logs,
      Transcript: ticketData.Logs, Description: "Support ticket", Emoji: "🎫", Enabled: true,
    ...
    await client.embed({ title, desc: description, components: [row] }, channel);
